...
Welcome to **Supa Snake**! This is a modern, responsive twist on the classic Snake game, built with a stunning retro-neon aesthetic. Guide your glowing snake to eat the elusive cyber-rat, grow longer, and climb the leaderboards.
...
- **Engaging Gameplay Mechanics**:
    ...
    - **Tricky AI Food**: The rat has its own movement pattern, making it a challenging and unpredictable target.
- **Immersive Visuals & Sound**:
    - A beautiful, glowing, retro-inspired theme with CRT scanlines and an animated grid background.
...
- **Firebase-Powered Features**:
    - **Authentication**: Sign up and log in to have your identity in the game.
    - **Global Chat**: Engage with other players in a real-time global chat. (Requires login)
...
- **Backend & Database**: [Firebase](https://firebase.google.com/) (Firestore for real-time chat, Firebase Auth for user management)
